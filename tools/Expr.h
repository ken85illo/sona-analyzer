...
public:
    ...
    static Ref<BinaryExpr> make(const Ref<Expr> left, const Ref<Token> op, const Ref<Expr> right) {
        return MakeRef<BinaryExpr>(left, op, right);
    }
};
...
public:
    ...
    static Ref<GroupingExpr> make(const Ref<Expr> expression) {
        return MakeRef<GroupingExpr>(expression);
    }
};
...
public:
    ...
    static Ref<LiteralExpr> make(const Ref<Token> value) {
        return MakeRef<LiteralExpr>(value);
    }
};
...
public:
    ...
    static Ref<UnaryExpr> make(const Ref<Token> op, const Ref<Expr> right) {
